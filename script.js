...
function tabulateAnswers() {
  ...
  if (c2score == maxscore) { // If user chooses the second choice the most, this outcome will be displayed.
    ...
    console.log('yes = '+c1score);
    console.log('no = '+c2score);
    answerbox.innerHTML = "<br><h2>YOUR RESULT:</h2><br><br><h2>Manual testing</h2><br><p>Please help me to answer a survey by clicking ANSWER SURVEY button at the bottom of this page. God bless you!</p><div class=\"card-group\"><div class=\"card\"><div class=\"container\"><h4><b>Procedure</b></h4><p>Manual testing is a testing done manually by human.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Approach</b></h4><p>Manual testing allowed the tester to do random testing in finding bugs and error.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Time taken</b></h4><p>Time taken to complete manual testing is very high (time consuming).</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Tools</b></h4><p>No tool is required to execute the testing.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Cost</b></h4><p>Not involved any cost for tools.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Manpower</b></h4><p>Required more tester as all the test cases will be executed manually.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Accuracy</b></h4><p>Low accuracy.</p></div></div><div class=\"card\"><div class=\"container\"><h4><b>Technical skills</b></h4><p>Not required any programming language.</p></div></div></div><br><br><p><a id=\"submit\" onclick=\"answerSurvey()\">ANSWER SURVEY</a><a type=\"reset\" id=\"reset\" onclick=\"resetAnswer()\">RESET</a></p>";
    document.getElementById("wrapper").style.display = "none";
    document.getElementById("wrapper2").style.opacity = "1";
